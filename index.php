 ...
 */
 ...
 /* 
    title: jokeboard
    author: lynam 
    desciprtion: redirect link jokeboard date 1-4-2017
*/
$getUrlParam = "";
$timeBetweenStar = strtotime('2017-4-1 00:00:00');
$timeBetweenEnd = strtotime('2017-4-1 23:59:59'); 
// check ajax
$headers = apache_request_headers();
$is_ajax = (isset($headers['X-Requested-With']) && $headers['X-Requested-With'] == 'XMLHttpRequest');
//encheck ajax
$timeNow = time();
if(empty($_COOKIE['redirectJokeBoard'])
   //&& empty(strpos($_SERVER['REQUEST_URI'], 'joke-board')) 
   && $timeBetweenStar <= $timeNow 
   && $timeNow <= $timeBetweenEnd
   && !$is_ajax ) {
    setcookie('redirectJokeBoard', 'joke-board');
    $actual_link = (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]/joke-board";
