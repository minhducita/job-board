    ...
    <div class="findNewJob">
        ...
        <div class="resultSearch">
                ...
                <div class="container">
                    ...
                    <div class="w-resultSearch">
                       ...
                       {/if}
                        ...
                        <div class="row mt15">
                            <div class="col-xs-12">
                                <a href="{$BASE_URL}mobile/find-new-job/?research=1" class="btn bgf1ae47"><i class="fa fa-pencil"></i> Change Condition</a>
                            </div>
                        </div>
            ...
            <div id="job-listings" class="job-listings">
                {include file="MobileTemplates/views/jobs/posts-loop.tpl"}
            </div><!-- #job-listings -->
        </div>
        </div>
