{include file="header.tpl"}
		...
		<div id="content">
			...
			<br />
            <div id="job-upper"><div id="number-views">Job ID : {$job_id}</div></div>
			...
			{else}
				...
				{else}
					...
					<ul>	
						...
						<li><a href="{$BASE_URL}delete/{$CURRENT_ID}/{$auth}/" title="{$translations.publish.delete}">&raquo; {$translations.publish.delete}</a></li>
					</ul>
				{/if}
			{/if}
		</div><!-- /content -->
