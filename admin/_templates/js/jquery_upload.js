 //Declaring and defining global increement variable
...
//following function will executes on change event of file input to select different file	
    $('body').on('change', '#file', function(){
            if (this.files && this.files[0]) {
			    ...
			    $(this).hide();
                $("#abcd"+ abc).append($("<img/>", {id: 'img', src: '../../../_templates/default/img/x.png', alt: 'delete'}).click(function() {
					$(this).parent().parent().remove();
					count_input = $(".iupload").length;
					if(count_input < 3){
...
function append_image_delete(){
    $(".abcd").each(function(){
        $(this).append($("<img/>",{id: 'img', src: '../../../_templates/default/img/x.png', alt: 'delete'}).click(function() {
            $(this).parent().parent().remove();
