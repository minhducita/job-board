...
<head>
	<title>{$html_title}{php} echo ' Admin - '.SITE_NAME;{/php}</title>
    ...
    <link rel="stylesheet" href="{$BASE_URL_ADMIN}_templates/css/jquery_upload.css">
    ...
    <script src="{$BASE_URL_ADMIN}_templates/js/jquery_upload.js"></script>
...
<div id="wrap">
	...
	{if $isAuthenticated == 1}
		<div id="search">
			<form id="search_form" method="post" action="{$BASE_URL_ADMIN}search/">
				<fieldset>
					<div>
						<input type="text" name="keywords" id="keywords" maxlength="30" value="{if $keywords}{$keywords}{/if}" placeholder="{$placeholder}" />
		...
		<ul class="sf-menu sf-navbar">
			...
			<li><a {if $CURRENT_PAGE == 'spotlight-jobs'}class="selected"{/if} href="{$BASE_URL_ADMIN}spotlight-jobs">Spotlight Jobs</a></li>
